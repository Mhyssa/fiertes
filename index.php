...
<div class="row mt-5" >
    ...
    <a href="assets\img\banniere_idahot_2021.JPG">
        <img src="assets/img/banniere_idahot_2021.JPG"
            alt="Banniere du festival idahot 2021 à Amiens"
            width="100%" class="shadow img-fluid mt-3">
    </a>
    </div>
</div>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------
    Details de la journée
------------------------------------------------------------------------------------------------------------------------------ -->

<div class="row block py-5">
<div class="col-0 col-md-2"></div>

    <div class="col-12 col-md-8">
        <h2 class="mb-5 text-center white">
            Déroulement du festival IDAHOT 2021
        </h2>
        <a href="assets\img\programme_idahot_2021.JPG"><img src="assets\img\programme_idahot_2021.JPG" alt="Programme du festival idahot 2021 à Amiens" class="img-fluid" width="100%"></a>
...
<div class="row justify-content-center blockOrange" id="about">
    <div class="col-9 col-sm-9 col-lg-6 p-4">
        <h2 class="text-center mb-4 white">Qui sommes nous ?</h2>
        <p class="thasadith white">Le collectif inter-associatif LGBTQI+ d'Amiens initialement collectif IDAHOT (International Day Against
            ...
            Ces 5 associations sont : Aides, Flash Our True Colors, Les Bavardes, Le GAS (Groupe d'Appui et de Solidarité), et SOShomophobie.
...
<div class="row justify-content-center pb-4">
    <div class="col-11 col-sm-11 col-md-6 mt-5">
        <iframe width="100%" height="350" src="https://www.youtube.com/embed/akLfSOXkd1Y" frameborder="0"
            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
</div>

<div class="row">
    <div class="col-lg-12 borderOrange pb-1 pt-2 mt-2"></div>   
</div>
...
<div class="row "> <!--block-light -->
    ...
    <div class="row justify-content-center ">
        <div class="col-md-11 m-auto"><!--block-1 -->
    ...
    <div class="row justify-content-center ">
    <div class="col-md-11 m-auto"><!--block-2 -->
        <div class="card mb-3 mr-2 float-left" style="max-width: 540px; min-height: 210px;">
        <div class="row no-gutters">
            <!-- Partenaire Flash -->
            <div class="col-md-4 p-3">
        ...
        <div class="row justify-content-center">
            <div class="col-11 col-sm-11 col-md-6 " >
                <h2 class="text-center mb-2 pt-5  blue">En images</h2>
                                <p class="text-center mb-4 pt-2 thasadith"> 178 photos exclusives par <a href="https://www.juliettefabijan.fr/" target="_blank">Juliette Fabijan</a> en cliquant sur une des images <i class="fas fa-angle-double-down fa-lg orange"></i></p>
